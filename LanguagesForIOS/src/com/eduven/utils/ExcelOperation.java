...
public class ExcelOperation {
	...
	static String file_location = "/Users/hiteshbhardwaj/Desktop/Automation/workspace/LanguagesForIOS/Testexcel.xlsx";
	...
	public static void main(String args[]) {
		for (int i = 0; i < getSheetDataValues().size(); i++){
			System.out.println("Value of i.."+i +" Excel Sheet Values.."+getSheetDataValues().get(i));
		}
	}
}
