...
from modules.custompd import spell_checker, send_ecard

class SeleniumTestScript(TestCase):
	
	def test_my_test_case(self):
		""" The actual test scenario: Test the eCard custome page 1
		spell check functionality on RTE box, for paid user. 		     
