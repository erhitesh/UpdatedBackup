...
public class TasteBudPageTestCases {
	...
	public void tasteBudPageVerifyTasteBudCategoryTest(){
		TasteBud.verifyTasteBudCategoryList(typeOfDietName);
	}
	...
	public void tasteBudPageVerifyTasteBudRecipeTermTest(){
		...
		TasteBud.navigateToTasteBudCategoryPage();
		tasteBudName = TasteBud.clickOnRandomTasteBudCategoryList(typeOfDietName);
		TasteBud.verifyTasteBudTermPageLoaded(tasteBudName);
		TasteBud.verifyTasteBudCategoryRecipeList(typeOfDietName, tasteBudName);
	}
