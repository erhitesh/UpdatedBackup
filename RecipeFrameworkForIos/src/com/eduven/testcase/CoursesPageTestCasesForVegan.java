...
import com.eduven.modules.CoursesForVegan;
...
public class CoursesPageTestCasesForVegan {
	...
	public void verifyCourseCategoryListTest(){
		Courses.verifyCourseList(typeOfDietForCategory);
	}
	...
	public void verifyCoursesRecipeListTest(){
		...
		Courses.navigateToCoursesCategoryPage();
		coursesName = Courses.clickOnRandomCourseCategoryList(typeOfDietForCategory);
		Courses.verifyCourseTermPageLoaded(coursesName);
		CoursesForVegan.verifyCoursesCategoryRecipeList(typeOfDietName, coursesName);
	}
