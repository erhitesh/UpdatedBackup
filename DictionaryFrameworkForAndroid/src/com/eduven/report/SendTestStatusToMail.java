...
public class SendTestStatusToMail {
	...
	public static void sendReportToMail(){
		sendMail("hitesh.bhardwaj@mediaagility.in", "bhardwajhitesh2", "smtp.gmail.com", "465", "true", "true", true, "javax.net.ssl.SSLSocketFactory", "false", "hitesh.bhardwaj@mediaagility.in", "rahul.sharma@mediaagility.in", "rahul.sharma@mediaagility.in", "Android Automation Report "+ DataConstants.appName + time_pattern+"", "Android Suite Execution Report Status.", path, "Test_Suite_Execution_Report.html");
	}
